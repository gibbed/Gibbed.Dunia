...
namespace Gibbed.Dunia.FileFormats.Big
{
    public struct Dependency<T> : IEquatable<Dependency<T>>
    {
        ...
        {
            return
                this.ArchiveHash.Equals(other.ArchiveHash) == true &&
        ...
        {
            int hashCode = -1363709565;
            hashCode = hashCode * -1521134295 + EqualityComparer<T>.Default.GetHashCode(this.ArchiveHash);
