...
namespace Gibbed.Dunia.FileFormats.Big
{
    internal class EntrySerializerV11 : IEntrySerializer<ulong>
    {
        ...
        // c: uuuuuuuu uuuuuuuu uuuuuuuu uuuuuuse
        // d: oooooooo oooooooo oooooooo oooooooo
        // e: OOOccccc cccccccc cccccccc cccccccc
        //
        // [h] hash (upper)       = 32 bits
        // [H] hash (lower)       = 32 bits
        // [e] is encrypted       =  1 bit
        // [s] is compressed      =  1 bit
        // [u] uncompressed size  = 30 bits
        // [o] offset (upper)     = 32 bits
        // [O] offset (lower)     =  3 bits
        // [c] compressed size    = 29 bits
        //
        // When encrypted, only the first 0x100000 bytes are encrypted with XTEA.
        //
        // Offset is always a multiple of 16, so raw offset is shifted left 4 bits.
